...
export const initKfactor = 20; // usually =32 but Norges Biljardforbund/cuescore uses 20 for some reason...
export const robustnessCoeff = 0.1; // coefficient for updating robustness
